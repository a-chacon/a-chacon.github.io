---
layout: post
title: "authenticate_by: Prevenir la enumeración de usuarios basada en tiempos de respuestas."
categories: [Ruby, Rails, Security]
excerpt: "Con la introducción de authenticate_by en Rails 7.1, ahora podemos prevenir los ataques de enumeración basados en tiempos de respuesta." 
