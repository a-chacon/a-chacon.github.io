---
layout: post
title: "Minitest-cc: A minimalistic way to know what is the code coverage of your tests."
categories: [Rails,Ruby,Minitest]
excerpt: Ministest-cc is a lightweight and simple plug-in for the Minitest framework that provides an output about the code coverage of your tests. Here we will see how to install it and how it works.
