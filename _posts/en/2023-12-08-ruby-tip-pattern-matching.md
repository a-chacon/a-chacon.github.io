...
If you are interested in the topic, I invite you to look for more information in the [documentation](https://docs.ruby-lang.org/en/master/syntax/pattern_matching_rdoc.html). There are other interesting elements of pattern matching, such as the use of the pin operator (^) and *Guard clauses* (`if` and `unless`).
